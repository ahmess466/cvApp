      ...
      <div class="row align-items-center h-100">
        ...
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" method="POST" action="{{ route('register') }}">
          ...
          <div class="form-group">
            ...
            <input type="text" id="inputName" class="form-control form-control-lg" placeholder="Name" name="name" :value="old('name')"required="" autofocus="">
          </div>
          <div class="form-group">
            <label for="inputEmail" class="sr-only">Email address</label>
            <input type="email" id="inputEmail" class="form-control form-control-lg" name="email" :value="old('email')"  placeholder="Email address" required="" autofocus="">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="password" id="inputPassword" name="password_confirmation" class="form-control form-control-lg" placeholder="Confirm Password" required="">
          </div>
