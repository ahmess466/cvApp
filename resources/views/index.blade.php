...
@include('include.footer')
   ...
   <script src="{{asset('frontendjs/jquery-3.0.0.min.js')}}"></script>
   <script src="{{asset('frontendjs/plugin.js')}}"></script>
   <!-- sidebar -->
   <script src="{{asset('frontendjs/jquery.mCustomScrollbar.concat.min.js')}}"></script>
   <script src="{{asset('frontendjs/custom.js')}}"></script>
   <script src="{{asset('frontendhttps:cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.js')}}"></script>
</body>
