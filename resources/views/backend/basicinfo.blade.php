          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <form class="needs-validation" method="POST" action="{{route('user.info')}}" novalidate>
                    @csrf
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <input class="form-control" name="phone" id="custom-phone"   placeholder="Enter phone number" required>
                    </div>
